...
public class H2ConfigTest {
    ...
    /*
    Enquanto os testes estiverem em execução ou em pausa (thread breakpoint) é possível acessar a estrutura do banco de dados enquanto está em memória em http://localhost:8084/fh-sistema-unico-saude/h2-console com as credenciais:
    Driver Class: org.h2.Driver
    JDBC URL: jdbc:h2:tcp://localhost:9093/mem:db
    User Name: sa
    Password:
