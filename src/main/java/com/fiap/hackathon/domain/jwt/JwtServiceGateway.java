...
import com.fiap.hackathon.domain.jwt.dto.JwtGeneratePostRequestDTO;
import com.fiap.hackathon.domain.jwt.dto.JwtResponseDTO;
import com.fiap.hackathon.domain.jwt.entity.Jwt;
import com.fiap.hackathon.domain.jwt.usecase.JwtIsActiveUseCase;
import com.fiap.hackathon.domain.jwt.usecase.JwtRefreshByBearerTokenUserCase;
import com.fiap.hackathon.domain.user.authuser.BundleAuthUserDetails;
...
import com.fiap.hackathon.global.exception.JwtNotFoundHttpException;
...
@Service
public class JwtServiceGateway extends BaseServiceGateway<IJwtRepository, Jwt> {
    ...
    @Autowired
    public JwtServiceGateway(IJwtRepository jwtRepository, JwtBuilder jwtBuilder, BundleAuthUserDetailsService bundleAuthUserDetailsService, AuthenticationManager authenticationManager, ModelMapper modelMapperPresenter) {
