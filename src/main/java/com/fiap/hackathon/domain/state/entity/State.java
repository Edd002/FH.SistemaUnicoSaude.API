package com.fiap.hackathon.domain.state.entity;

import com.fiap.hackathon.domain.city.entity.City;
import com.fiap.hackathon.domain.state.StateEntityListener;
import com.fiap.hackathon.domain.state.enumerated.constraint.StateConstraint;
