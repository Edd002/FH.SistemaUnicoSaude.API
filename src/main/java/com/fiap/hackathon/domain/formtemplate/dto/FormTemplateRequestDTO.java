...
public abstract class FormTemplateRequestDTO extends BaseRequestDTO {
    ...
    @Schema(description = "Nome do formulário.", example = "Formulário de ficha de visita domiciliar e territorial", maxLength = 255)
    ...
    @Schema(description = "CNS (Cartão Nacional de Saúde) do profissional do formulário.", example = "000.0000.0000.0000", maxLength = 255)
    ...
    @Schema(description = "CBO (Classificação Brasileira de Ocupações) do profissional do formulário.", example = "5151-05 – Agente Comunitário de Saúde (ACS)", maxLength = 255)
    ...
    @Schema(description = "CNES (Cadastro Nacional de Estabelecimentos de Saúde) do formulário.", example = "2005456", maxLength = 255)
    ...
    @Schema(description = "INE (Identificador Nacional de Equipe) do formulário.", example = "000000000", maxLength = 255)
