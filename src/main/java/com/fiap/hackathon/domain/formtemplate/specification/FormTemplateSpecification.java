...
public class FormTemplateSpecification extends BasicSpecification<FormTemplate> implements Specification<FormTemplate> {

    @Serial
    private static final long serialVersionUID = 1L;

    public FormTemplateSpecification(SearchCriteria searchCriteria) {
        super(searchCriteria);
    }

    @Override
    public Predicate toPredicate(@NonNull Root<FormTemplate> root, CriteriaQuery<?> query, @NonNull CriteriaBuilder builder) {
