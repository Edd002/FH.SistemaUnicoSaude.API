...
public enum AnswerConstraintEnum {
    ...
    @FieldNameConstants.Include T_ANSWER__FK_QUES_AND_FK_PAT_AND_VIS_OPTION_AND_FK_FORM_SUB_UK("A resposta para a questão informada para a opção de visita já encontra-se cadastrada para o paciente."),
