package com.fiap.hackathon.global.base.response.success;

import com.fiap.hackathon.global.base.BaseSuccessResponse;
...
public class BaseSuccessResponse202<T extends BaseResponseDTO> extends BaseSuccessResponse<T> {
	...
	@Override
	public ResponseEntity<BaseSuccessResponse202<T>> buildResponse() {
