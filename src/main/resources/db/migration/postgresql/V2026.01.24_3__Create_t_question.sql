...
ALTER TABLE public.t_question ADD CONSTRAINT T_QUESTION__TYPE_CHECK CHECK (type IN ('OPEN_FIELD', 'NUMERIC_FIELD', 'BOOLEAN_FIELD', 'DATE_FIELD', 'SHIFT_FIELD', 'GENDER_FIELD'));