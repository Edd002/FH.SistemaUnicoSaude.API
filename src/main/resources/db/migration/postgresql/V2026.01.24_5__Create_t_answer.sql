...
CREATE UNIQUE INDEX T_ANSWER__FK_QUESTION_AND_FK_FORM_SUBMISSION_UK ON public.t_answer (fk_question, fk_form_submission, deleted) WHERE deleted IS NULL OR deleted = false;
